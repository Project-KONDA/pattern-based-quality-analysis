	...
	protected void addPropertyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PropertyOptionParam_property_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PropertyOptionParam_property_feature", "_UI_PropertyOptionParam_type"),
				 ParametersPackage.Literals.PROPERTY_OPTION_PARAM__PROPERTY,
				 true,
				 false,
				 true,
				 null,
