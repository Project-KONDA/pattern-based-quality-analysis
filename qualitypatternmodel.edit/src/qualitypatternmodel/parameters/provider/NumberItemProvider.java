...
/**
 * This is the item provider adapter for a {@link qualitypatternmodel.parameters.Number} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NumberItemProvider extends ParameterValueItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ParametersPackage.Literals.NUMBER__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		qualitypatternmodel.parameters.Number number = (qualitypatternmodel.parameters.Number) object;
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(qualitypatternmodel.parameters.Number.class)) {
