...
/**
 * This is the item provider adapter for a {@link qualitypatternmodel.parameters.Boolean} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BooleanItemProvider extends ParameterValueItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ParametersPackage.Literals.BOOLEAN__VALUE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ParametersPackage.Literals.BOOLEAN__MATCH,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		qualitypatternmodel.parameters.Boolean bool = (qualitypatternmodel.parameters.Boolean) object;
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(qualitypatternmodel.parameters.Boolean.class)) {
