		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TextListParam_values_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TextListParam_values_feature", "_UI_TextListParam_type"),
				 ParametersPackage.Literals.TEXT_LIST_PARAM__VALUES,
				 true,
				 false,
				 false,
