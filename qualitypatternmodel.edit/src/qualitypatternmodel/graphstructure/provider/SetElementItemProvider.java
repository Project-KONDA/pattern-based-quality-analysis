...
/**
 * This is the item provider adapter for a {@link qualitypatternmodel.graphstructure.SetElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SetElementItemProvider extends ElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SetElementItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SetElement_previous_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SetElement_previous_feature", "_UI_SetElement_type"),
				 GraphstructurePackage.Literals.SET_ELEMENT__PREVIOUS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GraphstructurePackage.Literals.SET_ELEMENT__NEXT);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SetElement"));
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GraphstructurePackage.Literals.SET_ELEMENT__NEXT,
