...
/**
 * This is the item provider adapter for a {@link qualitypatternmodel.qualitypatternmodel.adaptionNeo4J.NeoPathPart} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NeoPathPartItemProvider extends PatternElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public NeoPathPartItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_NeoPathPart_type") :
			getString("_UI_NeoPathPart_type") + " " + label;
	}
