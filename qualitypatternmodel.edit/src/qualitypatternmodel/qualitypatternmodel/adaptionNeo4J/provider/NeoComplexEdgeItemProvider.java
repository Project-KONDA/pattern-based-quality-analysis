...
/**
 * This is the item provider adapter for a {@link qualitypatternmodel.qualitypatternmodel.adaptionNeo4J.NeoComplexEdge} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NeoComplexEdgeItemProvider extends NeoPathPartItemProvider {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AdaptionNeo4JPackage.Literals.NEO_COMPLEX_EDGE__NEO_PATH,
				 qualitypatternmodel.adaptionNeo4J.AdaptionNeo4JFactory.eINSTANCE.createNeoComplexEdge()));

		newChildDescriptors.add
			(createChildParameter
				(AdaptionNeo4JPackage.Literals.NEO_COMPLEX_EDGE__NEO_PATH,
				 qualitypatternmodel.adaptionNeo4J.AdaptionNeo4JFactory.eINSTANCE.createNeoSimpleEdge()));

		newChildDescriptors.add
			(createChildParameter
				(AdaptionNeo4JPackage.Literals.NEO_COMPLEX_EDGE__NEO_PATH,
				 qualitypatternmodel.adaptionNeo4J.AdaptionNeo4JFactory.eINSTANCE.createNeoUnspecifiedEdge()));
	}
