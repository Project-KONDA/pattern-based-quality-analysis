...
import qualitypatternmodel.qualitypatternmodel.textrepresentation.ParameterFragment;
...
/**
 * This is the item provider adapter for a {@link qualitypatternmodel.qualitypatternmodel.textrepresentation.ParameterFragment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ParameterFragmentItemProvider extends FragmentItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 qualitypatternmodel.qualitypatternmodel.textrepresentation.TextrepresentationPackage.Literals.PARAMETER_FRAGMENT__EXAMPLE_VALUE,
				 true,
				 false,
				 true,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 qualitypatternmodel.qualitypatternmodel.textrepresentation.TextrepresentationPackage.Literals.PARAMETER_FRAGMENT__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ParameterFragment.class)) {
			case qualitypatternmodel.qualitypatternmodel.textrepresentation.TextrepresentationPackage.PARAMETER_FRAGMENT__NAME:
