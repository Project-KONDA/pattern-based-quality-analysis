...
import qualitypatternmodel.qualitypatternmodel.adaptionrdf.RdfXor;

/**
 * This is the item provider adapter for a {@link qualitypatternmodel.qualitypatternmodel.adaptionrdf.RdfXor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RdfXorItemProvider extends RdfPathPartItemProvider {
	 ...
	 * @generated
	 */
	public RdfXorItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AdaptionrdfPackage.Literals.RDF_XOR__ITEMS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RdfXor"));
	}
	...
	public String getText(Object object) {
		String label = ((RdfXor)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_RdfXor_type") :
			getString("_UI_RdfXor_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(RdfXor.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AdaptionrdfPackage.Literals.RDF_XOR__ITEMS,
