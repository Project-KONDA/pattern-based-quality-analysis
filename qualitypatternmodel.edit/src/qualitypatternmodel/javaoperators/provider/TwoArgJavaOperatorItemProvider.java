...
public class TwoArgJavaOperatorItemProvider extends JavaOperatorItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addPrimitiveNodesPropertyDescriptor(object);
		}
		return itemPropertyDescriptors;
	}

	/**
	 * This adds a property descriptor for the Primitive Nodes feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addPrimitiveNodesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TwoArgJavaOperator_primitiveNodes_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TwoArgJavaOperator_primitiveNodes_feature", "_UI_TwoArgJavaOperator_type"),
				 JavaoperatorsPackage.Literals.TWO_ARG_JAVA_OPERATOR__PRIMITIVE_NODES,
				 true,
				 false,
				 true,
				 null,
