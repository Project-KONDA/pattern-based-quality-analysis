...
public class AxisPairItemProvider 
	 ...
	 * @generated
	 */
	public AxisPairItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AdaptionxmlPackage.Literals.AXIS_PAIR__TEXT_LITERAL_PARAM);
			childrenFeatures.add(AdaptionxmlPackage.Literals.AXIS_PAIR__AXIS_OPTION_PARAM);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/AxisPair"));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AxisPair.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AdaptionxmlPackage.Literals.AXIS_PAIR__TEXT_LITERAL_PARAM,
				 ParametersFactory.eINSTANCE.createTextLiteralParam()));

		newChildDescriptors.add
			(createChildParameter
				(AdaptionxmlPackage.Literals.AXIS_PAIR__AXIS_OPTION_PARAM,
