...
/**
 * This is the item provider adapter for a {@link qualitypatternmodel.Boolean} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BooleanItemProvider extends XSTypeItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 QualitypatternmodelPackage.Literals.BOOLEAN__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((qualitypatternmodel.Boolean)object).getId();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(qualitypatternmodel.Boolean.class)) {
			case QualitypatternmodelPackage.BOOLEAN__VALUE:
