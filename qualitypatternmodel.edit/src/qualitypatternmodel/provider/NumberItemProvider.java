...
import qualitypatternmodel.inputfields.provider.XSTypeItemProvider;

/**
 * This is the item provider adapter for a {@link qualitypatternmodel.Number} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NumberItemProvider extends XSTypeItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 QualitypatternmodelPackage.Literals.NUMBER__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((qualitypatternmodel.Number)object).getId();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(qualitypatternmodel.Number.class)) {
			case QualitypatternmodelPackage.NUMBER__VALUE:
