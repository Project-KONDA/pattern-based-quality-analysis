 ...
 * @generated
 */
public class SequenceEdgeItemProvider extends NeoPathItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AdaptionNeo4JPackage.Literals.SEQUENCE_EDGE__NEOPATH);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AdaptionNeo4JPackage.Literals.SEQUENCE_EDGE__NEOPATH,
				 AdaptionNeo4JFactory.eINSTANCE.createSequenceEdge()));

		newChildDescriptors.add
			(createChildParameter
				(AdaptionNeo4JPackage.Literals.SEQUENCE_EDGE__NEOPATH,
				 AdaptionNeo4JFactory.eINSTANCE.createSimpleEdge()));
