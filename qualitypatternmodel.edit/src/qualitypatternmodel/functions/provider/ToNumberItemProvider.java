 ...
 * @generated
 */
public class ToNumberItemProvider extends NumberOperatorsItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FunctionsPackage.Literals.TO_NUMBER__PROPERTY);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ToNumber.class)) {
