...
/**
 * This is the item provider adapter for a {@link qualitypatternmodel.functions.Count} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Count_argument_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Count_argument_feature", "_UI_Count_type"),
				 FunctionsPackage.Literals.COUNT__ARGUMENT,
				 true,
				 false,
				 true,
				 null,
