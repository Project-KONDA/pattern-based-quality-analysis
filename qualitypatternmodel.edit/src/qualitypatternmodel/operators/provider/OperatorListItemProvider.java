...
/**
 * This is the item provider adapter for a {@link qualitypatternmodel.operators.OperatorList} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OperatorListItemProvider extends PatternElementItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(OperatorsPackage.Literals.OPERATOR_LIST__OPERATORS);
		}
		...
		newChildDescriptors.add
			(createChildParameter
				(OperatorsPackage.Literals.OPERATOR_LIST__OPERATORS,
				 OperatorsFactory.eINSTANCE.createMatch()));

		newChildDescriptors.add
			(createChildParameter
				(OperatorsPackage.Literals.OPERATOR_LIST__OPERATORS,
				 OperatorsFactory.eINSTANCE.createComparison()));

		newChildDescriptors.add
			(createChildParameter
				(OperatorsPackage.Literals.OPERATOR_LIST__OPERATORS,
				 OperatorsFactory.eINSTANCE.createContains()));

		newChildDescriptors.add
			(createChildParameter
				(OperatorsPackage.Literals.OPERATOR_LIST__OPERATORS,
				 OperatorsFactory.eINSTANCE.createNullCheck()));
