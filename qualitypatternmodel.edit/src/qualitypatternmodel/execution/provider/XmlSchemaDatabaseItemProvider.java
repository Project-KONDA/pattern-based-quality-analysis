	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_XmlSchemaDatabase_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_XmlSchemaDatabase_name_feature", "_UI_XmlSchemaDatabase_type"),
				 ExecutionPackage.Literals.XML_SCHEMA_DATABASE__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
