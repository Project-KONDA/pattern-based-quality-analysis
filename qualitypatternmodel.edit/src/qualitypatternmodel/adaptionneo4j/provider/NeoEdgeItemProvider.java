		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NeoEdge_returnElement_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_NeoEdge_returnElement_feature", "_UI_NeoEdge_type"),
				 Adaptionneo4jPackage.Literals.NEO_EDGE__RETURN_ELEMENT,
				 true,
				 false,
				 false,
