...
//	}
	...
	public void cypherTest04FormulaQueryComp() {		
		try {
			...
			assertEquals(completePatterns.get(i).generateCypher(), "\nMATCH (varENode5:Regesta)\n"
					+ "WHERE EXISTS {\n"
					+ "      MATCH (varENode5)-[varEEdge4:PLACE_OF_ISSUE]-(varENode6:Place)}\n"
					+ "   AND EXISTS {\n"
					+ "      MATCH (varENode5)-[varEEdge5:APPEARS_IN]-(varENode7:IndexEntry:IndexPlace)}\n"
					+ "RETURN varENode5");
			i++;
			...
			assertEquals(completePatterns.get(i).generateCypher(), "\nMATCH (varENode5:IndexPlace)\n"
					+ "WHERE (EXISTS {\n"
					+ "      MATCH (varENode5)-[varEEdge4:IS_SUB_OF]-(varENode6:IndexPlace)}\n"
					+ "   OR EXISTS {\n"
					+ "      MATCH (varENode5)-[varEEdge5:placeOfIssue]-(varENode7:Regesta)})\n"
					+ "RETURN varENode5");
			i++;
