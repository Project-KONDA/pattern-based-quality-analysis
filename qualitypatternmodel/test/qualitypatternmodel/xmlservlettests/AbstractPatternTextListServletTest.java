...
public class AbstractPatternTextListServletTest {
	...
	public void doGetTest() throws IOException, JSONException {
		HttpURLConnection connection = (HttpURLConnection) new URL(XmlServletUtility.PATH_PREFIX + Util.ABSTRACT_PATTERN_TEXT_LIST_ENDPOINT + "card_abstract").openConnection();
