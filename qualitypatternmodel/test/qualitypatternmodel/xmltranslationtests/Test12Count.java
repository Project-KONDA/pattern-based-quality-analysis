...
//		Relation r1 = returnInCPattern.addOutgoing();
		Node nextToReturnInCPattern = r.getTarget();
	...
	public static CompletePattern getPatternCountInExists() throws InvalidityException, OperatorCycleException, MissingPatternContainerException {
		...
		Node n2 = ret.addOutgoing().getTarget().makePrimitive();
		...
		Node n3 = ret.addOutgoing(countPattern.getGraph()).getTarget().makeComplex();
...
//	}
	...
	public static List<PatternTestPair> getTestPairs() throws InvalidityException, OperatorCycleException, MissingPatternContainerException {
		...
		testPairs.add(new PatternTestPair("12", "Count", getPatternCountInPatternFinal(), "/*[name()='demo:data' and count(./*[name()='demo:x']) = 0.0]"));
		testPairs.add(new PatternTestPair("12", "CountExist", getPatternCountInExists(), "/*[name()='demo:data' and count(./*[name()='demo:building']) = 3.0]"));
		testPairs.add(new PatternTestPair("12", "CountFor", getPatternCountInForall(), "/*[name()='demo:data' and (every $x in /* satisfies $x[name()='demo:data' and count(./*[name()='demo:building']) = 3.0])]"));
		testPairs.add(new PatternTestPair("12", "CountNextExist", getPatternCountNextToExists(), "/*[name()='demo:data' and count(for $x in ./*[name()='demo:building'] for $y in $x/*[name()='demo:name'] return $x) = 3.0 and ./*[name()='demo:painting']]"));
		testPairs.add(new PatternTestPair("12", "CountNextForall", getPatternCountNextToForall(), "/*[name()='demo:data' and count(for $x in ./*[name()='demo:building'] for $y in $x/*[name()='demo:name'] return $x) = 3.0]"));
		testPairs.add(new PatternTestPair("12", "CountNot", getPatternCountInNot(), "/*[not(count(./*[name()='demo:building']) = 0.0)]"));
		testPairs.add(new PatternTestPair("12", "CountNextExistNested", getPatternCountNextToExistsNested(), "/*[name()='demo:data' and ./*[name()='demo:building' and count(for $x in ./*[name()='demo:address'] for $y in $x/*[name()='demo:city'] return $x) =1.0 and ./*[name()='demo:name']]]"));
		testPairs.add(new PatternTestPair("12", "CountNextForallNested", getPatternCountNextToForallNested(), "/*[name()='demo:data' and ./*[name()='demo:building' and count(for $x in ./*[name()='demo:address'] for $y in $x/*[name()='demo:city'] return $x) =1.0]]"));
		return testPairs;
	}
}