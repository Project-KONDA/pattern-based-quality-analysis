...
//		EMFValidationPreparation.registerDelegates();
    ...
    public static Collection<PatternTestPair> data() {
    	...
    	try {
//x    		pairs.addAll(Test00.getTestPairs());
//x    		pairs.addAll(Test01Axis.getTestPairs());
//x    		pairs.addAll(Test01AxisAlternative.getTestPairs());
//x    		pairs.addAll(Test01Reference.getTestPairs());
    		pairs.addAll(Test01XmlPropertyNavigation.getTestPairs());
//    		pairs.addAll(Test02Return.getTestPairs());
//x    		pairs.addAll(Test03Quantor.getTestPairs());
...
//x    		pairs.addAll(Test14StringLength.getTestPairs());
		} catch (Exception e) {
			e.printStackTrace();
		}
		return pairs;
