...
//		}
	...
	static CompletePattern getCARD3Midas() throws InvalidityException, OperatorCycleException, MissingPatternContainerException {
		...
		((PropertyOptionParamImpl) params.get(56)).setValue(PropertyKind.ATTRIBUTE);
		((TextLiteralParamImpl) params.get(55)).setValue("Type");
		((PropertyOptionParamImpl) params.get(54)).setValue(PropertyKind.ATTRIBUTE);
		((TextLiteralParamImpl) params.get(53)).setValue("Value");
		((PropertyOptionParamImpl) params.get(52)).setValue(PropertyKind.ATTRIBUTE);
		((TextLiteralParamImpl) params.get(51)).setValue("Type");
		((PropertyOptionParamImpl) params.get(50)).setValue(PropertyKind.ATTRIBUTE);
		((TextLiteralParamImpl) params.get(49)).setValue("Value");
		((PropertyOptionParamImpl) params.get(48)).setValue(PropertyKind.ATTRIBUTE);
		((TextLiteralParamImpl) params.get(47)).setValue("Type");
		((PropertyOptionParamImpl) params.get(46)).setValue(PropertyKind.ATTRIBUTE);
		((TextLiteralParamImpl) params.get(45)).setValue("Value");
		((PropertyOptionParamImpl) params.get(44)).setValue(PropertyKind.ATTRIBUTE);
		((TextLiteralParamImpl) params.get(43)).setValue("Type");
		((PropertyOptionParamImpl) params.get(42)).setValue(PropertyKind.ATTRIBUTE);
		((TextLiteralParamImpl) params.get(41)).setValue("Value");
		((PropertyOptionParamImpl) params.get(40)).setValue(PropertyKind.ATTRIBUTE);
		((TextLiteralParamImpl) params.get(39)).setValue("Type");
		((PropertyOptionParamImpl) params.get(38)).setValue(PropertyKind.ATTRIBUTE);
		((TextLiteralParamImpl) params.get(37)).setValue("Value");
		((PropertyOptionParamImpl) params.get(36)).setValue(PropertyKind.ATTRIBUTE);
		((TextLiteralParamImpl) params.get(35)).setValue("Type");
		((PropertyOptionParamImpl) params.get(34)).setValue(PropertyKind.ATTRIBUTE);
		((TextLiteralParamImpl) params.get(33)).setValue("Type");
		((PropertyOptionParamImpl) params.get(32)).setValue(PropertyKind.ATTRIBUTE);
