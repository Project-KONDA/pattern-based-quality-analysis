...
public class DemoPatternTexts {
	...
	public static void testDemoPatterns() throws InvalidityException, OperatorCycleException, MissingPatternContainerException, IOException {
		...
		completePatterns.addAll(DemoTextAppDup.getPatterns());
		completePatterns.addAll(DemoTextCard.getPatterns());
		completePatterns.addAll(DemoTextCompval.getPatterns());
		completePatterns.addAll(DemoTextFunc.getPatterns());
...
//		completePatterns.add(getConcreteLidoFuncPatternWithText());
	...
	public static void exportAllDemoPatternTexts() throws InvalidityException, OperatorCycleException, MissingPatternContainerException, IOException {
		...
		CompletePattern compAbstract = DemoTextCompval.getCompWithText();
		...
		CompletePattern cardAbstract = DemoTextCard.getCardWithText();
		...
		CompletePattern funcAbstract = DemoTextFunc.getFuncWithText();
		...
		CompletePattern appDupAbstract = DemoTextAppDup.getAppDupWithText();
		appDupAbstract.isValid(AbstractionLevel.ABSTRACT);
		EMFModelSave.exportToFile(appDupAbstract,"instances/demo_with_texts/approximate_duplicate_abstract", "patternstructure");
	}
	
//	public static void exportAllDemoPatternTextsOld() throws InvalidityException, OperatorCycleException, MissingPatternContainerException, IOException {
//		
//		// ------------- COMP ----------------
//		
