 ...
 * </p>
 * <ul>
 *   <li>{@link QualityPatternModel.impl.CountImpl#getArgument <em>Argument</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CountImpl extends NumberOperatorsImpl implements Count {
	...
	protected EClass eStaticClass() {
		return QualityPatternModelPackage.Literals.COUNT;
	}
		...
		if (argument != null && argument.eIsProxy()) {
			...
			if (argument != oldArgument) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, QualityPatternModelPackage.COUNT__ARGUMENT, oldArgument, argument));
			}
		}
		return argument;
	}
	...
	public void setArgument(SetElement newArgument) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QualityPatternModelPackage.COUNT__ARGUMENT, oldArgument, argument));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QualityPatternModelPackage.COUNT__ARGUMENT:
