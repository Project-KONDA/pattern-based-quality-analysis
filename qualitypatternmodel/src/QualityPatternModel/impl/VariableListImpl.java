 ...
 * </p>
 * <ul>
 *   <li>{@link QualityPatternModel.impl.VariableListImpl#getVariables <em>Variables</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VariableListImpl extends MinimalEObjectImpl.Container implements VariableList {
	...
	protected EClass eStaticClass() {
		return QualityPatternModelPackage.Literals.VARIABLE_LIST;
	}
	...
	public EList<Input> getVariables() {
		if (variables == null) {
			variables = new EObjectResolvingEList<Input>(Input.class, this, QualityPatternModelPackage.VARIABLE_LIST__VARIABLES);
		}
		return variables;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QualityPatternModelPackage.VARIABLE_LIST__VARIABLES:
				return getVariables();
		}
