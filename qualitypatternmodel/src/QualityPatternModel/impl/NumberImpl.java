 ...
 * </p>
 * <ul>
 *   <li>{@link QualityPatternModel.impl.NumberImpl#getNumber <em>Number</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NumberImpl extends InputImpl implements QualityPatternModel.Number {
	/**
	...
	public void setNumber(Double newNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QualityPatternModelPackage.NUMBER__NUMBER, oldNumber, number));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QualityPatternModelPackage.NUMBER__NUMBER:
				return getNumber();
		}
