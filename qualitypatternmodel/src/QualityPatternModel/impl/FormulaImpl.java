 ...
 * </p>
 * <ul>
 *   <li>{@link QualityPatternModel.impl.FormulaImpl#getArguments <em>Arguments</em>}</li>
 *   <li>{@link QualityPatternModel.impl.FormulaImpl#getOperator <em>Operator</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FormulaImpl extends ConditionImpl implements Formula {
	...
	protected EClass eStaticClass() {
		return QualityPatternModelPackage.Literals.FORMULA;
	}
	...
	public EList<Condition> getArguments() {
		if (arguments == null) {
			arguments = new EObjectContainmentEList<Condition>(Condition.class, this, QualityPatternModelPackage.FORMULA__ARGUMENTS);
		}
		return arguments;
	}
	...
	public void setOperator(LogicalOperator newOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QualityPatternModelPackage.FORMULA__OPERATOR, oldOperator, operator));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case QualityPatternModelPackage.FORMULA__ARGUMENTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QualityPatternModelPackage.FORMULA__ARGUMENTS:
				return getArguments();
			case QualityPatternModelPackage.FORMULA__OPERATOR:
				return getOperator();
		}
