 ...
 * </p>
 * <ul>
 *   <li>{@link QualityPatternModel.impl.SetElementImpl#getNext <em>Next</em>}</li>
 *   <li>{@link QualityPatternModel.impl.SetElementImpl#getPrevious <em>Previous</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SetElementImpl extends ElementImpl implements SetElement {
	...
	protected EClass eStaticClass() {
		return QualityPatternModelPackage.Literals.SET_ELEMENT;
	}
	...
	public EList<SetElement> getNext() {
		if (next == null) {
			next = new EObjectResolvingEList<SetElement>(SetElement.class, this, QualityPatternModelPackage.SET_ELEMENT__NEXT);
		}
		return next;
	}
		...
		if (previous != null && previous.eIsProxy()) {
			...
			if (previous != oldPrevious) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, QualityPatternModelPackage.SET_ELEMENT__PREVIOUS, oldPrevious, previous));
			}
		}
		return previous;
	}
	...
	public void setPrevious(Element newPrevious) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QualityPatternModelPackage.SET_ELEMENT__PREVIOUS, oldPrevious, previous));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QualityPatternModelPackage.SET_ELEMENT__NEXT:
				return getNext();
			case QualityPatternModelPackage.SET_ELEMENT__PREVIOUS:
