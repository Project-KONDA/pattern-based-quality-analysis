 ...
 * </p>
 * <ul>
 *   <li>{@link QualityPatternModel.impl.TextImpl#getText <em>Text</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TextImpl extends InputImpl implements Text {
	...
	protected EClass eStaticClass() {
		return QualityPatternModelPackage.Literals.TEXT;
	}
	...
	public void setText(String newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QualityPatternModelPackage.TEXT__TEXT, oldText, text));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QualityPatternModelPackage.TEXT__TEXT:
				return getText();
		}
