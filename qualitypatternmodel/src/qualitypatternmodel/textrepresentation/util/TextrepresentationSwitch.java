 ...
 * @generated
 */
public class TextrepresentationSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public TextrepresentationSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TextrepresentationPackage.PATTERN_TEXT: {
				PatternText patternText = (PatternText)theEObject;
				T result = casePatternText(patternText);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TextrepresentationPackage.PARAMETER_FRAGMENT: {
			...
			case TextrepresentationPackage.FRAGMENT: {
				Fragment fragment = (Fragment)theEObject;
				T result = caseFragment(fragment);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TextrepresentationPackage.TEXT_FRAGMENT: {
			...
			case TextrepresentationPackage.VALUE_MAP: {
				ValueMap valueMap = (ValueMap)theEObject;
				T result = caseValueMap(valueMap);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Pattern Text</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Pattern Text</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePatternText(PatternText object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Parameter Fragment</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Parameter Fragment</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseParameterFragment(ParameterFragment object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Value Map</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Value Map</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseValueMap(ValueMap object) {
		return null;
	}
