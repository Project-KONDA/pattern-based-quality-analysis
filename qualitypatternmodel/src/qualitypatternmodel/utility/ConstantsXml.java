...
public class ConstantsXml {
	...
	public static final String REGEX_ATTRIBUTE_NAME_PLUS_DATA = REGEX_NAMESPACE + "[A-Za-z0-9]+" + "(/data\\(\\))";
	public static final String REGEX_ATTRIBUTE_PLUS_DATA = "(@" + REGEX_ATTRIBUTE_NAME + "|@\\*\\[name\\(\\)[ ]*=[ ]*\"" + REGEX_ATTRIBUTE_NAME + "\"\\])" + "(/data\\(\\))";
	public static final String REGEX_ATTRIBUTE = REGEX_ATTRIBUTE_PLUS_DATA + "?"; //"(@" + REGEX_ATTRIBUTE_NAME + "|@\\*\\[name\\(\\)[ ]*=[ ]*\"" + REGEX_ATTRIBUTE_NAME + "\"\\])"";
