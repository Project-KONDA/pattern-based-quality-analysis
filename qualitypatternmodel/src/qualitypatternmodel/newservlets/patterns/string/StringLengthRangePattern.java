...
public class StringLengthRangePattern extends PatternClass {
	...
	public CompletePattern getPattern() throws InvalidityException, OperatorCycleException, MissingPatternContainerException {
		...
		StringLength sl1 = field.addPrimitiveStringLength();
		StringLength sl2 = field.addPrimitiveStringLength();
		

		if (ServletConstants.FILL_VALUES) {
			sl1.getNumber().setValue(0.);
			sl1.getOption().setValue(ComparisonOperator.GREATEROREQUAL);
			sl2.getNumber().setValue(2.);
			sl2.getOption().setValue(ComparisonOperator.LESSOREQUAL);
		}
