...
public class LinkSourceIsoPattern extends PatternClass {

	public LinkSourceIsoPattern() {
		super (PatternConstants.LINKSOURCEISO_ID,
				PatternConstants.LINKSOURCEISO_NAME, 
				PatternConstants.LINKSOURCEISO_DESCR, 
	...
	public CompletePattern getPattern() throws InvalidityException, OperatorCycleException, MissingPatternContainerException {
		...
		LinkSourceOperator op4 = JavaoperatorsFactory.eINSTANCE.createLinkSourceOperator();
