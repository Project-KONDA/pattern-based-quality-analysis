...
public class LinkMimeTypePattern extends PatternClass {

	public LinkMimeTypePattern() {
		super(PatternConstants.LINKMIMETYPE_ID,
				PatternConstants.LINKMIMETYPE_NAME, 
				PatternConstants.LINKMIMETYPE_DESCR, 
