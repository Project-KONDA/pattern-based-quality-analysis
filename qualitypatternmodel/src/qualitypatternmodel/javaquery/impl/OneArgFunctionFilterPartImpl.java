 ...
 *   <li>{@link qualitypatternmodel.javaquery.impl.OneArgFunctionFilterPartImpl#getQuantifier <em>Quantifier</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OneArgFunctionFilterPartImpl extends BooleanFilterPartImpl implements OneArgFunctionFilterPart {
	...
	public void setQuantifier(Quantifier newQuantifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JavaqueryPackage.ONE_ARG_FUNCTION_FILTER_PART__QUANTIFIER, oldQuantifier, quantifier));
	}
