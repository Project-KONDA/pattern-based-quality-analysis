...
public class JavaqueryoutputPackageImpl extends EPackageImpl implements JavaqueryoutputPackage {
	 ...
	 */
	@Override
	public EOperation getContainerResult__Stream__JSONObject() {
	 ...
	 */
	@Override
	public EOperation getInterimResultContainer__Stream__JSONObject() {
	...
	public void createPackageContents() {
		...
		createEOperation(containerResultEClass, CONTAINER_RESULT___STREAM__JSONOBJECT);
		...
		createEOperation(interimResultContainerEClass, INTERIM_RESULT_CONTAINER___STREAM__JSONOBJECT);
	}
	...
	public void initializePackageContents() {
		...
		op = initEOperation(getContainerResult__Stream__JSONObject(), ecorePackage.getEBooleanObject(), "stream", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEAttribute(getValueResult_Value(), theTextrepresentationPackage.getJSONObjectWrapper(), "value", null, 0, 1, ValueResult.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		op = initEOperation(getInterimResultContainer__Stream__JSONObject(), ecorePackage.getEBooleanObject(), "stream", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theTextrepresentationPackage.getJSONObjectWrapper(), "value", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEException(op, thePatternstructurePackage.getInvalidityExceptionWrapper());
