...
public class PatternstructurePackageImpl extends EPackageImpl implements PatternstructurePackage {
	 ...
	 */
	@Override
	public EOperation getPatternElement__InJavaQueryWhereClause() {
	...
	public void createPackageContents() {
		...
		createEOperation(patternElementEClass, PATTERN_ELEMENT___IN_JAVA_QUERY_WHERE_CLAUSE);
	...
	public void initializePackageContents() {
		...
		op = initEOperation(getPatternElement__InJavaQueryWhereClause(), ecorePackage.getEBooleanObject(), "inJavaQueryWhereClause", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEException(op, this.getInvalidityExceptionWrapper());
