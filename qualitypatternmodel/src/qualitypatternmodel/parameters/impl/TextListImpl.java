 ...
 * </p>
 * <ul>
 *   <li>{@link qualitypatternmodel.parameters.impl.TextListImpl#getValues <em>Values</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TextListImpl extends TextImpl implements TextList {
	...
	protected EClass eStaticClass() {
		return ParametersPackage.Literals.TEXT_LIST;
	}
	...
	public EList<String> getValues() {
		if (values == null) {
			values = new EDataTypeUniqueEList<String>(String.class, this, ParametersPackage.TEXT_LIST__VALUES);
		}
		return values;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ParametersPackage.TEXT_LIST__VALUES:
				return getValues();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ParametersPackage.TEXT_LIST___GET_LIST_DECLARATION:
				return getListDeclaration();
			case ParametersPackage.TEXT_LIST___GET_LIST_VAR:
				return getListVar();
		}
