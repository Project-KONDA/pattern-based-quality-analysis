 ...
 * </p>
 * <ul>
 *   <li>{@link qualitypatternmodel.parameters.impl.TimeImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TimeImpl extends ParameterValueImpl implements Time {
	...
	protected EClass eStaticClass() {
		return ParametersPackage.Literals.TIME;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ParametersPackage.TIME__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ParametersPackage.TIME__VALUE:
				return getValue();
		}
