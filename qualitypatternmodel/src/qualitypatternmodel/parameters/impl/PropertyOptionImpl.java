 ...
 * </p>
 * <ul>
 *   <li>{@link qualitypatternmodel.parameters.impl.PropertyOptionImpl#getOptions <em>Options</em>}</li>
 *   <li>{@link qualitypatternmodel.parameters.impl.PropertyOptionImpl#getValue <em>Value</em>}</li>
 *   <li>{@link qualitypatternmodel.parameters.impl.PropertyOptionImpl#getProperty <em>Property</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PropertyOptionImpl extends ParameterImpl implements PropertyOption {
	...
	protected EClass eStaticClass() {
		return ParametersPackage.Literals.PROPERTY_OPTION;
	}
	...
	public EList<PropertyLocation> getOptions() {
		if (options == null) {
			options = new EDataTypeUniqueEList<PropertyLocation>(PropertyLocation.class, this, ParametersPackage.PROPERTY_OPTION__OPTIONS);
		}
		return options;
	}
	...
	public void setValue(PropertyLocation newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ParametersPackage.PROPERTY_OPTION__VALUE, oldValue, value));
	}
	...
	public Property getProperty() {
		if (property != null && property.eIsProxy()) {
			...
			if (property != oldProperty) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ParametersPackage.PROPERTY_OPTION__PROPERTY, oldProperty, property));
			}
		}
		return property;
	}
	...
	public NotificationChain basicSetProperty(Property newProperty, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ParametersPackage.PROPERTY_OPTION__PROPERTY, oldProperty, newProperty);
	...
	public void setProperty(Property newProperty) {
		if (newProperty != property) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ParametersPackage.PROPERTY_OPTION__PROPERTY, newProperty, newProperty));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ParametersPackage.PROPERTY_OPTION__PROPERTY:
				if (property != null)
					msgs = ((InternalEObject)property).eInverseRemove(this, GraphstructurePackage.PROPERTY__OPTION, Property.class, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ParametersPackage.PROPERTY_OPTION__OPTIONS:
				return getOptions();
			case ParametersPackage.PROPERTY_OPTION__VALUE:
				return getValue();
			case ParametersPackage.PROPERTY_OPTION__PROPERTY:
