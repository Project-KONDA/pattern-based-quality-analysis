 ...
 * </p>
 * <ul>
 *   <li>{@link qualitypatternmodel.parameters.impl.TextLiteralImpl#getValue <em>Value</em>}</li>
 *   <li>{@link qualitypatternmodel.parameters.impl.TextLiteralImpl#getMatch <em>Match</em>}</li>
 *   <li>{@link qualitypatternmodel.parameters.impl.TextLiteralImpl#getProperty <em>Property</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TextLiteralImpl extends TextImpl implements TextLiteral {
	...
	protected EClass eStaticClass() {
		return ParametersPackage.Literals.TEXT_LITERAL;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ParametersPackage.TEXT_LITERAL__VALUE, oldValue, value));
	}
	...
	public Match getMatch() {
		if (match != null && match.eIsProxy()) {
			...
			if (match != oldMatch) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ParametersPackage.TEXT_LITERAL__MATCH, oldMatch, match));
			}
		}
		return match;
	}
	...
	public NotificationChain basicSetMatch(Match newMatch, NotificationChain msgs) {
		...
		match = newMatch;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ParametersPackage.TEXT_LITERAL__MATCH, oldMatch, newMatch);
	...
	public void setMatch(Match newMatch) {
		if (newMatch != match) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ParametersPackage.TEXT_LITERAL__MATCH, newMatch, newMatch));
	}
	...
	public Property getProperty() {
		if (property != null && property.eIsProxy()) {
			...
			if (property != oldProperty) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ParametersPackage.TEXT_LITERAL__PROPERTY, oldProperty, property));
			}
		}
		return property;
	}
	...
	public NotificationChain basicSetProperty(Property newProperty, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ParametersPackage.TEXT_LITERAL__PROPERTY, oldProperty, newProperty);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setProperty(Property newProperty) {
		if (newProperty != property) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ParametersPackage.TEXT_LITERAL__PROPERTY, newProperty, newProperty));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ParametersPackage.TEXT_LITERAL__MATCH:
				if (match != null)
					msgs = ((InternalEObject)match).eInverseRemove(this, FunctionsPackage.MATCH__REGULAR_EXPRESSION, Match.class, msgs);
				return basicSetMatch((Match)otherEnd, msgs);
			case ParametersPackage.TEXT_LITERAL__PROPERTY:
				if (property != null)
					msgs = ((InternalEObject)property).eInverseRemove(this, GraphstructurePackage.PROPERTY__ATTRIBUTE_NAME, Property.class, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ParametersPackage.TEXT_LITERAL__VALUE:
				return getValue();
			case ParametersPackage.TEXT_LITERAL__MATCH:
