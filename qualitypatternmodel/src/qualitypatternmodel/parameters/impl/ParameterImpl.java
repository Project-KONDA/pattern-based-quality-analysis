 ...
 * </p>
 * <ul>
 * <li>{@link qualitypatternmodel.parameters.impl.ParameterImpl#getComparison1
 * <em>Comparison1</em>}</li>
 * <li>{@link qualitypatternmodel.parameters.impl.ParameterImpl#getComparison2
 * <em>Comparison2</em>}</li>
 * <li>{@link qualitypatternmodel.parameters.impl.ParameterImpl#getParameterList
 * <em>Parameter List</em>}</li>
 * <li>{@link qualitypatternmodel.parameters.impl.ParameterImpl#getDescription
 * <em>Description</em>}</li>
 * <li>{@link qualitypatternmodel.parameters.impl.ParameterImpl#isIsPredefined
 * <em>Is Predefined</em>}</li>
 * <li>{@link qualitypatternmodel.parameters.impl.ParameterImpl#isDescribed
 * <em>Described</em>}</li>
 * </ul>
 *
 * @generated
...
public abstract class ParameterImpl extends PatternElementImpl implements Parameter {
	...
	/**
	 * The default value of the '{@link #isIsPredefined() <em>Is Predefined</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isIsPredefined()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #isIsPredefined() <em>Is Predefined</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isIsPredefined()
	 * @generated
	...
	/**
	 * The default value of the '{@link #isDescribed() <em>Described</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isDescribed()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #isDescribed() <em>Described</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isDescribed()
	 * @generated
...
//	}
	...
	public EList<Comparison> getComparison1() {
		if (comparison1 == null) {
			comparison1 = new EObjectWithInverseResolvingEList<Comparison>(Comparison.class, this,
					ParametersPackage.PARAMETER__COMPARISON1, FunctionsPackage.COMPARISON__ARGUMENT1);
		}
		return comparison1;
	}
	...
	public EList<Comparison> getComparison2() {
		if (comparison2 == null) {
			comparison2 = new EObjectWithInverseResolvingEList<Comparison>(Comparison.class, this,
					ParametersPackage.PARAMETER__COMPARISON2, FunctionsPackage.COMPARISON__ARGUMENT2);
		}
		return comparison2;
	}
	...
	public ParameterList getParameterList() {
		if (eContainerFeatureID() != ParametersPackage.PARAMETER__PARAMETER_LIST)
			return null;
	...
	public NotificationChain basicSetParameterList(ParameterList newParameterList, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newParameterList, ParametersPackage.PARAMETER__PARAMETER_LIST,
				msgs);
		return msgs;
	}
	...
	public void setParameterList(ParameterList newParameterList) {
		if (newParameterList != eInternalContainer()
				|| (eContainerFeatureID() != ParametersPackage.PARAMETER__PARAMETER_LIST && newParameterList != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ParametersPackage.PARAMETER__PARAMETER_LIST,
	...
	public void setIsPredefined(boolean newIsPredefined) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ParametersPackage.PARAMETER__IS_PREDEFINED,
					oldIsPredefined, isPredefined));
	}
	...
	public void setDescribed(boolean newDescribed) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ParametersPackage.PARAMETER__DESCRIBED, oldDescribed,
					described));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == qualitypatternmodel.graphstructure.Comparable.class) {
			...
			case ParametersPackage.PARAMETER__COMPARISON1:
				return GraphstructurePackage.COMPARABLE__COMPARISON1;
			case ParametersPackage.PARAMETER__COMPARISON2:
				return GraphstructurePackage.COMPARABLE__COMPARISON2;
			default:
				return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == qualitypatternmodel.graphstructure.Comparable.class) {
			...
			case GraphstructurePackage.COMPARABLE__COMPARISON1:
				return ParametersPackage.PARAMETER__COMPARISON1;
			case GraphstructurePackage.COMPARABLE__COMPARISON2:
				return ParametersPackage.PARAMETER__COMPARISON2;
			default:
				return -1;
			}
		}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == qualitypatternmodel.graphstructure.Comparable.class) {
			...
			case GraphstructurePackage.COMPARABLE___GET_RETURN_TYPE:
				return ParametersPackage.PARAMETER___GET_RETURN_TYPE;
			case GraphstructurePackage.COMPARABLE___IS_TRANSLATABLE:
				return ParametersPackage.PARAMETER___IS_TRANSLATABLE;
			case GraphstructurePackage.COMPARABLE___GET_ALL_ARGUMENT_ELEMENTS:
				return ParametersPackage.PARAMETER___GET_ALL_ARGUMENT_ELEMENTS;
			case GraphstructurePackage.COMPARABLE___VALIDATE__DIAGNOSTICCHAIN_MAP:
				return ParametersPackage.PARAMETER___VALIDATE__DIAGNOSTICCHAIN_MAP;
			default:
				return -1;
			}
		}
