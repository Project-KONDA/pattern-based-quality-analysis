 ...
 * </p>
 * <ul>
 *   <li>{@link qualitypatternmodel.parameters.impl.BooleanImpl#getValue <em>Value</em>}</li>
 *   <li>{@link qualitypatternmodel.parameters.impl.BooleanImpl#getMatch <em>Match</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BooleanImpl extends ParameterValueImpl implements qualitypatternmodel.parameters.Boolean {
	/**
	...
	protected EClass eStaticClass() {
		return ParametersPackage.Literals.BOOLEAN;
	}
	...
	public void setValue(Boolean newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ParametersPackage.BOOLEAN__VALUE, oldValue, value));
	}
	...
	public Match getMatch() {
		if (match != null && match.eIsProxy()) {
			...
			if (match != oldMatch) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ParametersPackage.BOOLEAN__MATCH, oldMatch, match));
			}
		}
		return match;
	}
	...
	public NotificationChain basicSetMatch(Match newMatch, NotificationChain msgs) {
		...
		match = newMatch;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ParametersPackage.BOOLEAN__MATCH, oldMatch, newMatch);
	...
	public void setMatch(Match newMatch) {
		if (newMatch != match) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ParametersPackage.BOOLEAN__MATCH, newMatch, newMatch));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ParametersPackage.BOOLEAN__MATCH:
				if (match != null)
					msgs = ((InternalEObject)match).eInverseRemove(this, FunctionsPackage.MATCH__OPTION, Match.class, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ParametersPackage.BOOLEAN__VALUE:
				return getValue();
			case ParametersPackage.BOOLEAN__MATCH:
