 ...
 * </p>
 * <ul>
 *   <li>{@link qualitypatternmodel.parameters.impl.DateTimeImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DateTimeImpl extends ParameterValueImpl implements DateTime {
	...
	protected EClass eStaticClass() {
		return ParametersPackage.Literals.DATE_TIME;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ParametersPackage.DATE_TIME__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ParametersPackage.DATE_TIME__VALUE:
				return getValue();
		}
