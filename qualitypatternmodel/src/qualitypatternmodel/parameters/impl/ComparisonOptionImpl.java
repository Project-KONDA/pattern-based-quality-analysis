 ...
 * </p>
 * <ul>
 *   <li>{@link qualitypatternmodel.parameters.impl.ComparisonOptionImpl#getOptions <em>Options</em>}</li>
 *   <li>{@link qualitypatternmodel.parameters.impl.ComparisonOptionImpl#getValue <em>Value</em>}</li>
 *   <li>{@link qualitypatternmodel.parameters.impl.ComparisonOptionImpl#getComparison <em>Comparison</em>}</li>
 * </ul>
 *
 * @generated
 */
...
//		getOptions().add(ComparisonOperator.LESSOREQUAL);
	...
	protected EClass eStaticClass() {
		return ParametersPackage.Literals.COMPARISON_OPTION;
	}
	...
	public EList<ComparisonOperator> getOptions() {
		if (options == null) {
			options = new EDataTypeUniqueEList<ComparisonOperator>(ComparisonOperator.class, this, ParametersPackage.COMPARISON_OPTION__OPTIONS);
		}
		return options;
	}
	...
	public void setValue(ComparisonOperator newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ParametersPackage.COMPARISON_OPTION__VALUE, oldValue, value));
	}
	...
	public Comparison getComparison() {
		if (comparison != null && comparison.eIsProxy()) {
			...
			if (comparison != oldComparison) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ParametersPackage.COMPARISON_OPTION__COMPARISON, oldComparison, comparison));
			}
		}
		return comparison;
	}
	...
	public NotificationChain basicSetComparison(Comparison newComparison, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ParametersPackage.COMPARISON_OPTION__COMPARISON, oldComparison, newComparison);
	...
	public void setComparison(Comparison newComparison) {
		if (newComparison != comparison) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ParametersPackage.COMPARISON_OPTION__COMPARISON, newComparison, newComparison));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ParametersPackage.COMPARISON_OPTION__COMPARISON:
				if (comparison != null)
					msgs = ((InternalEObject)comparison).eInverseRemove(this, FunctionsPackage.COMPARISON__OPTION, Comparison.class, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ParametersPackage.COMPARISON_OPTION__OPTIONS:
				return getOptions();
			case ParametersPackage.COMPARISON_OPTION__VALUE:
				return getValue();
			case ParametersPackage.COMPARISON_OPTION__COMPARISON:
