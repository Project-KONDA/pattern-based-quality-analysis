 ...
 * </p>
 * <ul>
 *   <li>{@link qualitypatternmodel.parameters.impl.AxisOptionImpl#getOptions <em>Options</em>}</li>
 *   <li>{@link qualitypatternmodel.parameters.impl.AxisOptionImpl#getValue <em>Value</em>}</li>
 *   <li>{@link qualitypatternmodel.parameters.impl.AxisOptionImpl#getRelation <em>Relation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AxisOptionImpl extends ParameterImpl implements AxisOption {
	...
	protected EClass eStaticClass() {
		return ParametersPackage.Literals.AXIS_OPTION;
	}
	...
	public EList<Axis> getOptions() {
		if (options == null) {
			options = new EDataTypeUniqueEList<Axis>(Axis.class, this, ParametersPackage.AXIS_OPTION__OPTIONS);
		}
		return options;
	}
	...
	public void setValue(Axis newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ParametersPackage.AXIS_OPTION__VALUE, oldValue, value));
	}
	...
	public Relation getRelation() {
		if (relation != null && relation.eIsProxy()) {
			...
			if (relation != oldRelation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ParametersPackage.AXIS_OPTION__RELATION, oldRelation, relation));
			}
		}
		return relation;
	}
	...
	public NotificationChain basicSetRelation(Relation newRelation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ParametersPackage.AXIS_OPTION__RELATION, oldRelation, newRelation);
	...
	public void setRelation(Relation newRelation) {
		if (newRelation != relation) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ParametersPackage.AXIS_OPTION__RELATION, newRelation, newRelation));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ParametersPackage.AXIS_OPTION__RELATION:
				if (relation != null)
					msgs = ((InternalEObject)relation).eInverseRemove(this, GraphstructurePackage.RELATION__OPTION, Relation.class, msgs);
