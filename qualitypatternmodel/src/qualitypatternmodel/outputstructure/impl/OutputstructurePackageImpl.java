...
import qualitypatternmodel.outputstructure.InterimResultPart;
 ...
 * @generated
 */
public class OutputstructurePackageImpl extends EPackageImpl implements OutputstructurePackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see qualitypatternmodel.outputstructure.OutputstructurePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private OutputstructurePackageImpl() {
		super(eNS_URI, OutputstructureFactory.eINSTANCE);
	}
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 *
	 * <p>This method is used to initialize {@link OutputstructurePackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static OutputstructurePackage init() {
		if (isInited) return (OutputstructurePackage)EPackage.Registry.INSTANCE.getEPackage(OutputstructurePackage.eNS_URI);

		// Obtain or create and register package
		Object registeredOutputstructurePackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		OutputstructurePackageImpl theOutputstructurePackage = registeredOutputstructurePackage instanceof OutputstructurePackageImpl ? (OutputstructurePackageImpl)registeredOutputstructurePackage : new OutputstructurePackageImpl();
		...
		theOutputstructurePackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(OutputstructurePackage.eNS_URI, theOutputstructurePackage);
		return theOutputstructurePackage;
	}
	 ...
	 */
	@Override
	public OutputstructureFactory getOutputstructureFactory() {
		return (OutputstructureFactory)getEFactoryInstance();
	}
