...
public class Util {
	...
	public static final String APPLICATION_ENDPOINT = PROJECT_PREFIX_ENDPOINT + "/finalized-patterns/application";
	...
	public static final String DATABASE_GETTING_ENDPOINT = PROJECT_PREFIX_ENDPOINT + "/databases/get/";
