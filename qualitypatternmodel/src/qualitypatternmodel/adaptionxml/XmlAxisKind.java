 ...
 * <!-- end-user-doc -->
 * @see qualitypatternmodel.adaptionxml.AdaptionxmlPackage#getXmlAxisKind()
 * @model
 * @generated
 */
public enum XmlAxisKind implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Xml Axis Kind</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final XmlAxisKind[] VALUES_ARRAY =
		new XmlAxisKind[] {
			CHILD,
			DESCENDANT,
			PARENT,
	...
	/**
	 * A public read-only list of all the '<em><b>Xml Axis Kind</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<XmlAxisKind> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Xml Axis Kind</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static XmlAxisKind get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			XmlAxisKind result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Xml Axis Kind</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static XmlAxisKind getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			XmlAxisKind result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Xml Axis Kind</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static XmlAxisKind get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private XmlAxisKind(int value, String name, String literal) {
		this.value = value;
		this.name = name;
