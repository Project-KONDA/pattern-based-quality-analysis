 ...
 * </p>
 * <ul>
 *   <li>{@link qualitypatternmodel.adaptionxml.impl.RelationOptionParamImpl#getOptions <em>Options</em>}</li>
 *   <li>{@link qualitypatternmodel.adaptionxml.impl.RelationOptionParamImpl#getValue <em>Value</em>}</li>
 *   <li>{@link qualitypatternmodel.adaptionxml.impl.RelationOptionParamImpl#getRelations <em>Relations</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RelationOptionParamImpl extends ParameterImpl implements RelationOptionParam {
	...
	protected EClass eStaticClass() {
		return AdaptionxmlPackage.Literals.RELATION_OPTION_PARAM;
	}
	...
	public EList<RelationKind> getOptions() {
		if (options == null) {
			options = new EDataTypeUniqueEList<RelationKind>(RelationKind.class, this, AdaptionxmlPackage.RELATION_OPTION_PARAM__OPTIONS);
		}
		else if (options.size() > 1){
			EList<RelationKind> options2 = new EDataTypeUniqueEList<RelationKind>(RelationKind.class, this, AdaptionxmlPackage.RELATION_OPTION_PARAM__OPTIONS);
	...
	public void setValue(RelationKind newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdaptionxmlPackage.RELATION_OPTION_PARAM__VALUE, oldValue, value));
	}
	...
	public EList<XmlNavigation> getRelations() {
		if (relations == null) {
			relations = new EObjectWithInverseResolvingEList<XmlNavigation>(XmlNavigation.class, this, AdaptionxmlPackage.RELATION_OPTION_PARAM__RELATIONS, AdaptionxmlPackage.XML_NAVIGATION__OPTION);
		}
		return relations;
	}
...
//							}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AdaptionxmlPackage.RELATION_OPTION_PARAM__RELATIONS:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case AdaptionxmlPackage.RELATION_OPTION_PARAM___INFER_SUGGESTIONS:
				return inferSuggestions();
			case AdaptionxmlPackage.RELATION_OPTION_PARAM___SET_VALUE_IF_VALID__RELATIONKIND:
				try {
