...
public interface XmlAxisPartCondition extends Parameter {
	 ...
	 * @model opposite="xmlAxisPartCondition" required="true"
	 * @generated
	 */
	XmlPropertyOptionParam getXmlPropertyOption();

	/**
	 * Sets the value of the '{@link qualitypatternmodel.adaptionxml.XmlAxisPartCondition#getXmlPropertyOption <em>Xml Property Option</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the value of the '<em><b>Text Literal Param</b></em>' reference.
	 ...
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Text Literal Param</em>' reference.
	 ...
	 * @model opposite="xmlAxisPartCondition"
	 * @generated
	 */
	TextLiteralParam getTextLiteralParam();

	/**
	 * Sets the value of the '{@link qualitypatternmodel.adaptionxml.XmlAxisPartCondition#getTextLiteralParam <em>Text Literal Param</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Text Literal Param</em>' reference.
	 ...
	 * @model opposite="xmlAxisPartConditions"
	 * @generated
	 */
	XmlAxisPart getXmlAxisPart();

	/**
	 * Sets the value of the '{@link qualitypatternmodel.adaptionxml.XmlAxisPartCondition#getXmlAxisPart <em>Xml Axis Part</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
