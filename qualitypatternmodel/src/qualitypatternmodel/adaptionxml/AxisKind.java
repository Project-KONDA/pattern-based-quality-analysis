 ...
 * <!-- end-user-doc -->
 * @see qualitypatternmodel.adaptionxml.AdaptionxmlPackage#getAxisKind()
 * @model
 * @generated
 */
public enum AxisKind implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Axis Kind</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final AxisKind[] VALUES_ARRAY =
		new AxisKind[] {
			CHILD,
			DESCENDANT,
			PARENT,
	...
	/**
	 * A public read-only list of all the '<em><b>Axis Kind</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<AxisKind> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Axis Kind</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static AxisKind get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			AxisKind result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Axis Kind</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static AxisKind getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			AxisKind result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Axis Kind</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static AxisKind get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private AxisKind(int value, String name, String literal) {
		this.value = value;
		this.name = name;
