 ...
 *   <li>{@link qualitypatternmodel.execution.impl.XmlSchemaImpl#getSchemaContext <em>Schema Context</em>}</li>
 *   <li>{@link qualitypatternmodel.execution.impl.XmlSchemaImpl#getNamespace <em>Namespace</em>}</li>
 *   <li>{@link qualitypatternmodel.execution.impl.XmlSchemaImpl#getAttributeNames <em>Attribute Names</em>}</li>
 *   <li>{@link qualitypatternmodel.execution.impl.XmlSchemaImpl#getElementNames <em>Element Names</em>}</li>
 *   <li>{@link qualitypatternmodel.execution.impl.XmlSchemaImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class XmlSchemaImpl extends MinimalEObjectImpl.Container implements XmlSchema {
	...
	public void setSchemaContext(Context newSchemaContext) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExecutionPackage.XML_SCHEMA__SCHEMA_CONTEXT, oldSchemaContext, schemaContext));
	}
	...
	public void setNamespace(String newNamespace) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExecutionPackage.XML_SCHEMA__NAMESPACE, oldNamespace, namespace));
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ExecutionPackage.XML_SCHEMA___ANALYSE_SCHEMA:
				try {
					analyseSchema();
					return null;
				}
			...
			case ExecutionPackage.XML_SCHEMA___OPEN_SCHEMA_DATABASE:
				try {
					openSchemaDatabase();
					return null;
				}
			...
			case ExecutionPackage.XML_SCHEMA___INIT_SCHEMA_DATABASE:
				try {
					initSchemaDatabase();
					return null;
				}
			...
			case ExecutionPackage.XML_SCHEMA___CHECK_FOLLOWING_IN_SCHEMA__STRING_STRING:
				try {
			...
			case ExecutionPackage.XML_SCHEMA___CHECK_PARENT_IN_SCHEMA__STRING_STRING:
				try {
			...
			case ExecutionPackage.XML_SCHEMA___CHECK_ANCESTOR_IN_SCHEMA__STRING_STRING:
				try {
			...
			case ExecutionPackage.XML_SCHEMA___CHECK_PRECEDING_SIBLING_IN_SCHEMA__STRING_STRING:
				try {
			...
			case ExecutionPackage.XML_SCHEMA___CHECK_DESCENDANT_IN_SCHEMA__STRING_STRING:
				try {
			...
			case ExecutionPackage.XML_SCHEMA___CHECK_CHILD_IN_SCHEMA__STRING_STRING:
				try {
			...
			case ExecutionPackage.XML_SCHEMA___CHECK_ATTRIBUTE_IN_SCHEMA__STRING_STRING:
				try {
			...
			case ExecutionPackage.XML_SCHEMA___CHECK_KEY_REF_IN_SCHEMA__STRING_STRING:
				try {
			...
			case ExecutionPackage.XML_SCHEMA___CHECK_PRECEDING_IN_SCHEMA__STRING_STRING:
				try {
			...
			case ExecutionPackage.XML_SCHEMA___CHECK_FOLLOWING_SIBLING_IN_SCHEMA__STRING_STRING:
				try {
			...
			case ExecutionPackage.XML_SCHEMA___GET_ANCESTORS_IN_SCHEMA__STRING:
				try {
			...
			case ExecutionPackage.XML_SCHEMA___GET_DESCENDANTS_IN_SCHEMA__STRING:
				try {
			...
			case ExecutionPackage.XML_SCHEMA___GET_CHILDREN_IN_SCHEMA__STRING:
				try {
			...
			case ExecutionPackage.XML_SCHEMA___GET_FOLLOWING_IN_SCHEMA__STRING:
				try {
			...
			case ExecutionPackage.XML_SCHEMA___GET_PRECEDING_IN_SCHEMA__STRING:
				try {
			...
			case ExecutionPackage.XML_SCHEMA___GET_PARENTS_IN_SCHEMA__STRING:
				try {
			...
			case ExecutionPackage.XML_SCHEMA___GET_ATTRIBUTES_IN_SCHEMA__STRING:
				try {
			...
			case ExecutionPackage.XML_SCHEMA___GET_FOLLOWING_SIBLINGS_IN_SCHEMA__STRING:
				try {
			...
			case ExecutionPackage.XML_SCHEMA___GET_PRECEDING_SIBLINGS_IN_SCHEMA__STRING:
				try {
	...
	public EMap<String, Integer> getElementNames() {
		if (elementNames == null) {
			elementNames = new EcoreEMap<String,Integer>(ExecutionPackage.Literals.STRING_TO_INT_MAP, StringToIntMapImpl.class, this, ExecutionPackage.XML_SCHEMA__ELEMENT_NAMES);
		}
		return elementNames;
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExecutionPackage.XML_SCHEMA__NAME, oldName, name));
	}
	...
	public EMap<String, Integer> getAttributeNames() {
		if (attributeNames == null) {
			attributeNames = new EcoreEMap<String,Integer>(ExecutionPackage.Literals.STRING_TO_INT_MAP, StringToIntMapImpl.class, this, ExecutionPackage.XML_SCHEMA__ATTRIBUTE_NAMES);
		}
