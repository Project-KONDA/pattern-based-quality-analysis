 ...
 * </p>
 * <ul>
 *   <li>{@link qualitypatternmodel.inputfields.impl.DateImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DateImpl extends InputValueImpl implements Date {
	...
	protected EClass eStaticClass() {
		return InputfieldsPackage.Literals.DATE;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InputfieldsPackage.DATE__VALUE, oldValue, value));
	}
	...
	public String myToString() {
		return "date " + getValue() + " (" + getShortPatternInternalId() + ")";
	}
