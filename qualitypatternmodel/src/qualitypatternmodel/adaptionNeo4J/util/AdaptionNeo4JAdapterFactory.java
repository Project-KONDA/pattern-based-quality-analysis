...
public class AdaptionNeo4JAdapterFactory extends AdapterFactoryImpl {
	...
	protected AdaptionNeo4JSwitch<Adapter> modelSwitch =
		new AdaptionNeo4JSwitch<Adapter>() {
			...
			@Override
			public Adapter caseNeoUnspecifiedEdge(NeoUnspecifiedEdge object) {
				return createNeoUnspecifiedEdgeAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link qualitypatternmodel.adaptionNeo4J.NeoUnspecifiedEdge <em>Neo Unspecified Edge</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
