...
public class AdaptionNeo4JSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case AdaptionNeo4JPackage.NEO_UNSPECIFIED_EDGE: {
				NeoUnspecifiedEdge neoUnspecifiedEdge = (NeoUnspecifiedEdge)theEObject;
				T result = caseNeoUnspecifiedEdge(neoUnspecifiedEdge);
				if (result == null) result = caseNeoPathPart(neoUnspecifiedEdge);
				if (result == null) result = casePatternElement(neoUnspecifiedEdge);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Neo Unspecified Edge</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Neo Unspecified Edge</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseNeoUnspecifiedEdge(NeoUnspecifiedEdge object) {
		return null;
	}
