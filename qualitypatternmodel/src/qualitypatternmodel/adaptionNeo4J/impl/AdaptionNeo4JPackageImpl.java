...
public class AdaptionNeo4JPackageImpl extends EPackageImpl implements AdaptionNeo4JPackage {
	 ...
	 */
	@Override
	public EAttribute getNeoPathPart_IsLastEdge() {
		return (EAttribute)neoPathPartEClass.getEStructuralFeatures().get(3);
	}
	...
	public EReference getNeoPathPart_NeoComplexEdge() {
		return (EReference)neoPathPartEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 */
	@Override
	public EOperation getNeoPathPart__GenerateCypherWithoutLabels() {
	 ...
	 */
	@Override
	public EOperation getNeoPathPart__GetCypherInnerEdgeNodes() {
	 ...
	 */
	@Override
	public EOperation getNeoPathPart__GetReturnCypherInnerEdgeNodes() {
	 ...
	 */
	@Override
	public EOperation getNeoPropertyNode__GenerateCypherMatchNodeVariable() {
	 ...
	 */
	@Override
	public EOperation getNeoPropertyEdge__GenerateCypherMatchNodeVariable() {
	 ...
	 */
	@Override
	public EOperation getNeoAbstractEdge__GetReturnVariable() {
	...
	public EOperation getNeoAbstractEdge__GetReturnInnerEdgeNodes() {
		return neoAbstractEdgeEClass.getEOperations().get(2);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(neoPathPartEClass, NEO_PATH_PART__IS_LAST_EDGE);
		...
		createEOperation(neoPathPartEClass, NEO_PATH_PART___GET_CYPHER_INNER_EDGE_NODES);
		createEOperation(neoPathPartEClass, NEO_PATH_PART___GET_RETURN_CYPHER_INNER_EDGE_NODES);
		...
		createEOperation(neoPropertyNodeEClass, NEO_PROPERTY_NODE___GENERATE_CYPHER_MATCH_NODE_VARIABLE);
		...
		createEOperation(neoPropertyEdgeEClass, NEO_PROPERTY_EDGE___GENERATE_CYPHER_MATCH_NODE_VARIABLE);
		...
		createEOperation(neoAbstractEdgeEClass, NEO_ABSTRACT_EDGE___GET_RETURN_VARIABLE);
	...
	public void initializePackageContents() {
		...
		EOperation op = initEOperation(getNeoAbstractNode__GetCypherReturnVariable(), ecorePackage.getEString(), "getCypherReturnVariable", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = initEOperation(getNeoNode__AddStringLabel__String(), null, "addStringLabel", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEReference(getNeoComplexEdge_NeoPath(), this.getNeoPathPart(), this.getNeoPathPart_NeoComplexEdge(), "neoPath", null, 2, -1, NeoComplexEdge.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		op = initEOperation(getNeoComplexEdge__ValidateComplexEdge(), ecorePackage.getEBoolean(), "validateComplexEdge", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEException(op, thePatternstructurePackage.getInvalidityExceptionWrapper());
		...
		initEAttribute(getNeoPathPart_IsLastEdge(), ecorePackage.getEBoolean(), "isLastEdge", "false", 0, 1, NeoPathPart.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getNeoPathPart_NeoComplexEdge(), this.getNeoComplexEdge(), this.getNeoComplexEdge_NeoPath(), "neoComplexEdge", null, 0, 1, NeoPathPart.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		op = initEOperation(getNeoPathPart__GenerateCypherWithoutLabels(), ecorePackage.getEString(), "generateCypherWithoutLabels", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEException(op, thePatternstructurePackage.getInvalidityExceptionWrapper());

		initEOperation(getNeoPathPart__IsLastEdge(), ecorePackage.getEBoolean(), "isLastEdge", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = initEOperation(getNeoPathPart__GetCypherInnerEdgeNodes(), ecorePackage.getEString(), "getCypherInnerEdgeNodes", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEException(op, thePatternstructurePackage.getInvalidityExceptionWrapper());

		op = initEOperation(getNeoPathPart__GetReturnCypherInnerEdgeNodes(), ecorePackage.getEString(), "getReturnCypherInnerEdgeNodes", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEException(op, thePatternstructurePackage.getInvalidityExceptionWrapper());
		...
		op = initEOperation(getNeoPropertyNode__GenerateCypherMatchNodeVariable(), ecorePackage.getEString(), "generateCypherMatchNodeVariable", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEException(op, thePatternstructurePackage.getInvalidityExceptionWrapper());
		...
		op = initEOperation(getNeoPropertyEdge__GenerateCypherMatchNodeVariable(), ecorePackage.getEString(), "generateCypherMatchNodeVariable", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEException(op, thePatternstructurePackage.getInvalidityExceptionWrapper());
