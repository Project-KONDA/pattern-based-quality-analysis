 ...
 * </p>
 * <ul>
 *   <li>{@link qualitypatternmodel.adaptionNeo4J.impl.NeoPathParamImpl#getParameterList <em>Parameter List</em>}</li>
 ...
 * @generated
 */
public class NeoPathParamImpl extends PatternElementImpl implements NeoPathParam {
	/**
	...
	public ParameterList getParameterList() {
		if (eContainerFeatureID() != AdaptionNeo4JPackage.NEO_PATH_PARAM__PARAMETER_LIST) return null;
	...
	public NotificationChain basicSetParameterList(ParameterList newParameterList, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newParameterList, AdaptionNeo4JPackage.NEO_PATH_PARAM__PARAMETER_LIST, msgs);
		return msgs;
	}
	...
	public void setParameterList(ParameterList newParameterList) {
		if (newParameterList != eInternalContainer() || (eContainerFeatureID() != AdaptionNeo4JPackage.NEO_PATH_PARAM__PARAMETER_LIST && newParameterList != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AdaptionNeo4JPackage.NEO_PATH_PARAM__PARAMETER_LIST, newParameterList, newParameterList));
	}
	...
	public void setPredefined(boolean newPredefined) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdaptionNeo4JPackage.NEO_PATH_PARAM__PREDEFINED, oldPredefined, predefined));
	}
	...
	public EList<ParameterReference> getParameterReferences() {
		if (parameterReferences == null) {
			parameterReferences = new EObjectWithInverseResolvingEList.ManyInverse<ParameterReference>(ParameterReference.class, this, AdaptionNeo4JPackage.NEO_PATH_PARAM__PARAMETER_REFERENCES, TextrepresentationPackage.PARAMETER_REFERENCE__PARAMETER);
		}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdaptionNeo4JPackage.NEO_PATH_PARAM__DESCRIPTION, oldDescription, description));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AdaptionNeo4JPackage.NEO_PATH_PARAM__PARAMETER_LIST:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetParameterList((ParameterList)otherEnd, msgs);
			case AdaptionNeo4JPackage.NEO_PATH_PARAM__PARAMETER_REFERENCES:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Parameter.class) {
			switch (derivedFeatureID) {
				case AdaptionNeo4JPackage.NEO_PATH_PARAM__PARAMETER_LIST: return ParametersPackage.PARAMETER__PARAMETER_LIST;
				case AdaptionNeo4JPackage.NEO_PATH_PARAM__PREDEFINED: return ParametersPackage.PARAMETER__PREDEFINED;
				case AdaptionNeo4JPackage.NEO_PATH_PARAM__PARAMETER_REFERENCES: return ParametersPackage.PARAMETER__PARAMETER_REFERENCES;
				case AdaptionNeo4JPackage.NEO_PATH_PARAM__DESCRIPTION: return ParametersPackage.PARAMETER__DESCRIPTION;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Parameter.class) {
			switch (baseFeatureID) {
				case ParametersPackage.PARAMETER__PARAMETER_LIST: return AdaptionNeo4JPackage.NEO_PATH_PARAM__PARAMETER_LIST;
				case ParametersPackage.PARAMETER__PREDEFINED: return AdaptionNeo4JPackage.NEO_PATH_PARAM__PREDEFINED;
				case ParametersPackage.PARAMETER__PARAMETER_REFERENCES: return AdaptionNeo4JPackage.NEO_PATH_PARAM__PARAMETER_REFERENCES;
				case ParametersPackage.PARAMETER__DESCRIPTION: return AdaptionNeo4JPackage.NEO_PATH_PARAM__DESCRIPTION;
				default: return -1;
			}
		}
		if (baseClass == NeoAbstractPathParam.class) {
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == Parameter.class) {
			switch (baseOperationID) {
				case ParametersPackage.PARAMETER___VALIDATE__DIAGNOSTICCHAIN_MAP: return AdaptionNeo4JPackage.NEO_PATH_PARAM___VALIDATE__DIAGNOSTICCHAIN_MAP;
				case ParametersPackage.PARAMETER___VALIDATE_AGAINST_SCHEMA: return AdaptionNeo4JPackage.NEO_PATH_PARAM___VALIDATE_AGAINST_SCHEMA;
				case ParametersPackage.PARAMETER___VALIDATE_EXAMPLE_VALUE__STRING: return AdaptionNeo4JPackage.NEO_PATH_PARAM___VALIDATE_EXAMPLE_VALUE__STRING;
				case ParametersPackage.PARAMETER___INPUT_IS_VALID: return AdaptionNeo4JPackage.NEO_PATH_PARAM___INPUT_IS_VALID;
				case ParametersPackage.PARAMETER___IS_USED: return AdaptionNeo4JPackage.NEO_PATH_PARAM___IS_USED;
				case ParametersPackage.PARAMETER___SET_VALUE_FROM_STRING__STRING: return AdaptionNeo4JPackage.NEO_PATH_PARAM___SET_VALUE_FROM_STRING__STRING;
				case ParametersPackage.PARAMETER___GET_VALUE_AS_STRING: return AdaptionNeo4JPackage.NEO_PATH_PARAM___GET_VALUE_AS_STRING;
				case ParametersPackage.PARAMETER___CHECK_COMPARISON_CONSISTENCY: return AdaptionNeo4JPackage.NEO_PATH_PARAM___CHECK_COMPARISON_CONSISTENCY;
				case ParametersPackage.PARAMETER___GET_OPTIONS_AS_STRING_LIST: return AdaptionNeo4JPackage.NEO_PATH_PARAM___GET_OPTIONS_AS_STRING_LIST;
				case ParametersPackage.PARAMETER___GENERATE_DESCRIPTION: return AdaptionNeo4JPackage.NEO_PATH_PARAM___GENERATE_DESCRIPTION;
				default: return -1;
			}
		}
		if (baseClass == NeoAbstractPathParam.class) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case AdaptionNeo4JPackage.NEO_PATH_PARAM___INPUT_IS_VALID:
				return inputIsValid();
			case AdaptionNeo4JPackage.NEO_PATH_PARAM___IS_USED:
				return isUsed();
			case AdaptionNeo4JPackage.NEO_PATH_PARAM___SET_VALUE_FROM_STRING__STRING:
				try {
			...
			case AdaptionNeo4JPackage.NEO_PATH_PARAM___GET_VALUE_AS_STRING:
				return getValueAsString();
			case AdaptionNeo4JPackage.NEO_PATH_PARAM___CHECK_COMPARISON_CONSISTENCY:
				try {
			...
			case AdaptionNeo4JPackage.NEO_PATH_PARAM___GET_OPTIONS_AS_STRING_LIST:
				return getOptionsAsStringList();
			case AdaptionNeo4JPackage.NEO_PATH_PARAM___GENERATE_DESCRIPTION:
