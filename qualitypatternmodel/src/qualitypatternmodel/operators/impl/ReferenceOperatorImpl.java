 ...
 * </p>
 * <ul>
 *   <li>{@link qualitypatternmodel.operators.impl.ReferenceOperatorImpl#getProperty2 <em>Property2</em>}</li>
 *   <li>{@link qualitypatternmodel.operators.impl.ReferenceOperatorImpl#getProperty1 <em>Property1</em>}</li>
 *   <li>{@link qualitypatternmodel.operators.impl.ReferenceOperatorImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
...
public class ReferenceOperatorImpl extends BooleanOperatorImpl implements ReferenceOperator {
	...
	protected EClass eStaticClass() {
		return OperatorsPackage.Literals.REFERENCE_OPERATOR;
	}
		...
		if (property2 != null && property2.eIsProxy()) {
			...
			if (property2 != oldProperty2) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OperatorsPackage.REFERENCE_OPERATOR__PROPERTY2, oldProperty2, property2));
			}
		}
		return property2;
	}
	...
	public void setProperty2(Property newProperty2) {
		if (newProperty2 != property2) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, OperatorsPackage.REFERENCE_OPERATOR__PROPERTY2, newProperty2, newProperty2));
	}
	...
	public Property getProperty1() {
		if (property1 != null && property1.eIsProxy()) {
			...
			if (property1 != oldProperty1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OperatorsPackage.REFERENCE_OPERATOR__PROPERTY1, oldProperty1, property1));
			}
		}
		return property1;
	}
	...
	public void setProperty1(Property newProperty1) {
		if (newProperty1 != property1) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, OperatorsPackage.REFERENCE_OPERATOR__PROPERTY1, newProperty1, newProperty1));
	}
	...
	public void setType(ReturnType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OperatorsPackage.REFERENCE_OPERATOR__TYPE, oldType, type));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case OperatorsPackage.REFERENCE_OPERATOR__PROPERTY2:
				if (property2 != null)
					msgs = ((InternalEObject)property2).eInverseRemove(this, GraphstructurePackage.PROPERTY__REFERENCE_OPERATOR2, Property.class, msgs);
				return basicSetProperty2((Property)otherEnd, msgs);
			case OperatorsPackage.REFERENCE_OPERATOR__PROPERTY1:
				if (property1 != null)
					msgs = ((InternalEObject)property1).eInverseRemove(this, GraphstructurePackage.PROPERTY__REFERENCE_OPERATOR1, Property.class, msgs);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case OperatorsPackage.REFERENCE_OPERATOR___COPY:
				return copy();
		}
