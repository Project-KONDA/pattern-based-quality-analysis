...
public class PropertyOptionParamTest extends ParameterTest {
	...
	public static void main(String[] args) {
		TestRunner.run(PropertyOptionParamTest.class);
	}

	/**
	 * Constructs a new Property Option Param test case with the given name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public PropertyOptionParamTest(String name) {
		super(name);
	}

	/**
	 * Returns the fixture for this Property Option Param test case.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	@Override
	protected PropertyOptionParam getFixture() {
		return (PropertyOptionParam)fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture(ParametersFactory.eINSTANCE.createPropertyOptionParam());
	}
