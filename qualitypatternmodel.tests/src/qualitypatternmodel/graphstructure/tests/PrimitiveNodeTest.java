...
/**
 * <!-- begin-user-doc -->
 * A test case for the model object '<em><b>Primitive Node</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class PrimitiveNodeTest extends NodeTest {
	...
	public static void main(String[] args) {
		TestRunner.run(PrimitiveNodeTest.class);
	}

	/**
	 * Constructs a new Primitive Node test case with the given name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public PrimitiveNodeTest(String name) {
		super(name);
	}

	/**
	 * Returns the fixture for this Primitive Node test case.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	protected void setUp() throws Exception {
		setFixture(GraphstructureFactory.eINSTANCE.createPrimitiveNode());
	}
