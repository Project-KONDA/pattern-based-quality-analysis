 ...
 * @generated
 */
public abstract class ComparableTest extends PatternElementTest {
	 ...
	 */
	@Override
	protected qualitypatternmodel.graphstructure.Comparable getFixture() {
		return (qualitypatternmodel.graphstructure.Comparable)fixture;
	}
