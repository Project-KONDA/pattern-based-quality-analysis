...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>patternstructure</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class PatternstructureExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(PatternstructurePackage.eNS_URI, 
			 PatternstructurePackage.eINSTANCE);
