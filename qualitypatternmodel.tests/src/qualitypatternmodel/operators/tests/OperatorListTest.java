 ...
 * <ul>
 *   <li>{@link qualitypatternmodel.operators.OperatorList#add(qualitypatternmodel.operators.Operator) <em>Add</em>}</li>
 * </ul>
 * </p>
 * @generated
 */
public class OperatorListTest extends PatternElementTest {
	...
	protected void setUp() throws Exception {
		setFixture(OperatorsFactory.eINSTANCE.createOperatorList());
	}
	...
	/**
	 * Tests the '{@link qualitypatternmodel.operators.OperatorList#add(qualitypatternmodel.operators.Operator) <em>Add</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
