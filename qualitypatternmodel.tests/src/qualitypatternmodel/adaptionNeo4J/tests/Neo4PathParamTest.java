...
/**
 * <!-- begin-user-doc -->
 * A test case for the model object '<em><b>Neo4 Path Param</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class Neo4PathParamTest extends ParameterTest {
	...
	public static void main(String[] args) {
		TestRunner.run(Neo4PathParamTest.class);
	}

	/**
	 * Constructs a new Neo4 Path Param test case with the given name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Neo4PathParamTest(String name) {
		super(name);
	}

	/**
	 * Returns the fixture for this Neo4 Path Param test case.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	@Override
	protected Neo4PathParam getFixture() {
		return (Neo4PathParam)fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture(AdaptionNeo4JFactory.eINSTANCE.createNeo4PathParam());
	}
