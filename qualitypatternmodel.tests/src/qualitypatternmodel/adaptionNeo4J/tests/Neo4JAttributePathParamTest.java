...
/**
 * <!-- begin-user-doc -->
 * A test case for the model object '<em><b>Neo4 JAttribute Path Param</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class Neo4JAttributePathParamTest extends ParameterTest {
	...
	public static void main(String[] args) {
		TestRunner.run(Neo4JAttributePathParamTest.class);
	}

	/**
	 * Constructs a new Neo4 JAttribute Path Param test case with the given name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Neo4JAttributePathParamTest(String name) {
		super(name);
	}

	/**
	 * Returns the fixture for this Neo4 JAttribute Path Param test case.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	@Override
	protected NeoAttributePathParam getFixture() {
		return (NeoAttributePathParam)fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture(AdaptionNeo4JFactory.eINSTANCE.createNeo4JAttributePathParam());
	}
