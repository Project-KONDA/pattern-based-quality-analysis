...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>javaqueryoutput</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class JavaqueryoutputExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(JavaqueryoutputPackage.eNS_URI, 
			 JavaqueryoutputPackage.eINSTANCE);
