...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>inputfields</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class InputfieldsExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(InputfieldsPackage.eNS_URI, 
			 InputfieldsPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				...
				ComparisonOption root = InputfieldsFactory.eINSTANCE.createComparisonOption();
